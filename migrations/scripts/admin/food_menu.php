...
$db = getDB();
$items = $db->query(
    "SELECT id, name, description, price, category, image, is_available, sort_order
...
<div class="fmbg" id="fm-modal">
    <div class="fmbox">
        ...
        <div class="fm-g2">
            <div class="fm-fg"><label>Category</label><input type="text" id="fm-cat" placeholder="Main" value="Main"></div>
...
function openItemModal() {
    ...
    document.getElementById('fm-cat').value = 'Main';
...
function editItem(btn) {
    ...
    document.getElementById('fm-cat').value = data.category || 'Main';
...
async function saveItem() {
    ...
    fd.append('category', document.getElementById('fm-cat').value || 'Main');
