...
//  Only trusts X-Forwarded-For if your app sits behind a
//  known reverse proxy. Set TRUSTED_PROXY_IPS in env.
// ============================================================
function getClientIp(): string {
    ...
    if (!empty($trustedProxies) && in_array($remoteAddr, $trustedProxies, true)) {
        // Only look at X-Forwarded-For when the direct connection is a trusted proxy
