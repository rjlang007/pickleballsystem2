    ...
    <div class="location-grid">
      <div class="location-info">
        ...
        <div class="info-card reveal delay-16">
          ...
          <div><div class="info-label">Contact</div><div class="info-value">📱 <?= h($location['phone'] ?? '+63 912 345 6789') ?><br>📧 <?= h($location['email'] ?? 'padolpickleball@gmail.com') ?></div></div>
        </div>
...
<footer>
  <div class="footer-grid">
    ...
    <div>
      ...
      <div class="footer-contact-item"><svg fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg><span><?= h($location['email'] ?? 'padolpickleball@gmail.com') ?></span></div>
